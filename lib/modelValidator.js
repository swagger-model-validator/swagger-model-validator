...
Validator.prototype.validate = function(target, swaggerModel, swaggerModels) {
    return validate(target, swaggerModel, swaggerModels);
};

function validate(target, swaggerModel, swaggerModels) {
    if(!target) {
